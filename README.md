...
> **Note**
>
> `Format` will not lint / format your requests, only your statically
...
To install `Format`, run the following from your project directory and
follow the prompts:
